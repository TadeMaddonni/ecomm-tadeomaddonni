    ...
    return(
        <div className="itemContainer">
            <div className="item">
                ...
                <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor"  viewBox="0 0 16 16">
                ...
                <button className="btnComprar" onClick={onAdd}>
                    <svg className="aurisAddToCart bi bi-cart-plus-fill" xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor"  viewBox="0 0 16 16">
