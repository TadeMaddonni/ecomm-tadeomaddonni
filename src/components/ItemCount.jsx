    ...
    return(
        <div className="itemContainer">
            <div className="item">
                ...
                <button className="btnComprar" onClick={() => {onAdd(stock,count )}}>
                    <svg className="aurisAddToCart bi bi-cart-plus-fill" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"  viewBox="0 0 16 16">
